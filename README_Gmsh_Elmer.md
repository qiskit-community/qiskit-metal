...
- **ElmerFEM is an external binary**, not a Python package — `pip install "quantum-metal[fem]"` does NOT install it. You install it separately from the official Elmer CSC distribution.
