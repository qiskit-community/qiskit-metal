...
class TransmonPocketTeeth(BaseQubit):
    ...
    def make_pocket(self):
        ...
        ).buffer(pad_height / 2, cap_style=CAP_STYLE.round)
        ...
        ).buffer(coupled_pad_width / 2, cap_style=CAP_STYLE.round)
    ...
    def make_connection_pad(self, name: str):
        ...
        if float(loc_W) != 0:
            ...
            connector_pad = draw.rectangle(pad_width, pad_height, 0, pad_height / 2)
