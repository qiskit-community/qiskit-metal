...
class TransmonConcentric(BaseQubit):
    ...
    def make(self):
        ...
        self.add_qgeometry(
            "path", geom_rr, layer=p.layer, subtract=False, width=p.cpw_width
        )
        self.add_qgeometry(
            "path", geom_fbl, layer=p.layer, subtract=False, width=p.cpw_width
        )
        ...
        self.add_qgeometry(
            "junction", geom_jjt, layer=p.layer, subtract=False, width=p.inductor_width
        )
        self.add_qgeometry(
            "junction", geom_jjb, layer=p.layer, subtract=False, width=p.inductor_width
        )
