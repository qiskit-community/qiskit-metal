...
class ResonatorLumped(QComponent):
    ...
    def make(self):
        ...
        # start the resonator
        initial = draw.LineString(
            [(0.0, p.perimeter_thickness), (0.0, p.perimeter_thickness + p.initial)]
        )
        ...
        arc_last = draw.rotate(
            arc,
            180,
            origin=(0.0, p.perimeter_thickness + p.initial + 1.5 * p.turn_radius),
        )
        ...
        # add to qgeometry
        self.add_qgeometry("poly", geom_perimeter, layer=p.layer, subtract=False)
        self.add_qgeometry(
            "path", geom_initial, layer=p.layer, subtract=False, width=p.res_width
        )
        self.add_qgeometry(
            "path", geom_arc, layer=p.layer, subtract=False, width=p.res_width
        )
        self.add_qgeometry(
            "path", geom_arc_left_1, layer=p.layer, subtract=False, width=p.res_width
        )
        self.add_qgeometry(
            "path", geom_arc_left_2, layer=p.layer, subtract=False, width=p.res_width
        )
        self.add_qgeometry(
            "path", geom_arc_left_3, layer=p.layer, subtract=False, width=p.res_width
        )
        self.add_qgeometry(
            "path", geom_arc_left_4, layer=p.layer, subtract=False, width=p.res_width
        )
        self.add_qgeometry(
            "path", geom_arc_left_5, layer=p.layer, subtract=False, width=p.res_width
        )
        self.add_qgeometry(
            "path", geom_arc_left_6, layer=p.layer, subtract=False, width=p.res_width
        )
        self.add_qgeometry(
            "path", geom_arc_left_7, layer=p.layer, subtract=False, width=p.res_width
        )
        self.add_qgeometry(
            "path", geom_arc_right_1, layer=p.layer, subtract=False, width=p.res_width
        )
        self.add_qgeometry(
            "path", geom_arc_right_2, layer=p.layer, subtract=False, width=p.res_width
        )
        self.add_qgeometry(
            "path", geom_arc_right_3, layer=p.layer, subtract=False, width=p.res_width
        )
        self.add_qgeometry(
            "path", geom_arc_right_4, layer=p.layer, subtract=False, width=p.res_width
        )
        self.add_qgeometry(
            "path", geom_arc_right_5, layer=p.layer, subtract=False, width=p.res_width
        )
        self.add_qgeometry(
            "path", geom_arc_right_6, layer=p.layer, subtract=False, width=p.res_width
        )
        self.add_qgeometry(
            "path", geom_arc_right_7, layer=p.layer, subtract=False, width=p.res_width
        )
        self.add_qgeometry(
            "path", geom_arc_last, layer=p.layer, subtract=False, width=p.res_width
        )
        self.add_qgeometry(
            "path", geom_line1, layer=p.layer, subtract=False, width=p.res_width
        )
        self.add_qgeometry(
            "path", geom_line2, layer=p.layer, subtract=False, width=p.res_width
        )
        self.add_qgeometry(
            "path", geom_line3, layer=p.layer, subtract=False, width=p.res_width
        )
        self.add_qgeometry(
            "path", geom_line4, layer=p.layer, subtract=False, width=p.res_width
        )
        self.add_qgeometry(
            "path", geom_line5, layer=p.layer, subtract=False, width=p.res_width
        )
        self.add_qgeometry(
            "path", geom_line6, layer=p.layer, subtract=False, width=p.res_width
        )
        self.add_qgeometry(
            "path", geom_line7, layer=p.layer, subtract=False, width=p.res_width
        )
        self.add_qgeometry(
            "path", geom_line8, layer=p.layer, subtract=False, width=p.res_width
        )
        self.add_qgeometry(
            "path", geom_line9, layer=p.layer, subtract=False, width=p.res_width
        )
        self.add_qgeometry(
            "path", geom_line10, layer=p.layer, subtract=False, width=p.res_width
        )
        self.add_qgeometry(
            "path", geom_line11, layer=p.layer, subtract=False, width=p.res_width
        )
        self.add_qgeometry(
            "path", geom_line12, layer=p.layer, subtract=False, width=p.res_width
        )
        self.add_qgeometry(
            "path", geom_line13, layer=p.layer, subtract=False, width=p.res_width
        )
        self.add_qgeometry(
            "path", geom_line14, layer=p.layer, subtract=False, width=p.res_width
        )
        self.add_qgeometry(
            "path", geom_line_last, layer=p.layer, subtract=False, width=p.res_width
        )
        self.add_qgeometry(
            "path", geom_final, layer=p.layer, subtract=False, width=p.res_width
        )
        ...
        self.add_pin(
            "pin_east", points=np.array([qp1a, qp1b]), width=0.01, input_as_norm=True
        )
        # North-East pin
        qpa_ne = (
            0.5 * p.box_width - p.perimeter_thickness,
        ...
        self.add_pin(
            "pin_ne", points=np.array([qpa_ne, qpb_ne]), width=0.01, input_as_norm=True
        )
        # South-East pin
        qpa_se = (
            0.5 * p.box_width - p.perimeter_thickness,
        ...
        self.add_pin(
            "pin_se", points=np.array([qpa_se, qpb_se]), width=0.01, input_as_norm=True
        )
        # North-West pin
        qpa_nw = (
            -0.5 * p.box_width + p.perimeter_thickness,
        ...
        self.add_pin(
            "pin_nw", points=np.array([qpa_nw, qpb_nw]), width=0.01, input_as_norm=True
        )
        # West pin
        ...
        self.add_pin(
            "pin_west", points=np.array([qp2a, qp2b]), width=0.01, input_as_norm=True
        )
        # South-West pin
        qpa_sw = (
            -0.5 * p.box_width + p.perimeter_thickness,
        ...
        self.add_pin(
            "pin_sw", points=np.array([qpa_sw, qpb_sw]), width=0.01, input_as_norm=True
        )
        # South pin
        ...
        self.add_pin(
            "pin_s", points=np.array([qpa_s, qpb_s]), width=0.01, input_as_norm=True
        )
        # north pin
        qpa_n = (
            0.0,
        ...
        self.add_pin(
            "pin_n", points=np.array([qpa_n, qpb_n]), width=0.01, input_as_norm=True
        )
