...
class Ui_ElementsWindow(object):
    def setupUi(self, ElementsWindow):
        ...
        QtCore.QObject.connect(
            self.combo_element_type,
            QtCore.SIGNAL("currentIndexChanged(QString)"),
            ElementsWindow.combo_element_type,
        )
        QtCore.QObject.connect(
            self.btn_refresh, QtCore.SIGNAL("clicked()"), ElementsWindow.force_refresh
        )
        QtCore.QMetaObject.connectSlotsByName(ElementsWindow)

    def retranslateUi(self, ElementsWindow):
        ElementsWindow.setWindowTitle(
            QtWidgets.QApplication.translate("ElementsWindow", "MainWindow", None, -1)
        )
        self.btn_refresh.setToolTip(
            QtWidgets.QApplication.translate(
                "ElementsWindow", "Force refresh the table ", None, -1
            )
        )
        ...
        self.label.setText(
            QtWidgets.QApplication.translate(
                "ElementsWindow", "QGeometry type: ", None, -1
            )
        )
        ...
        self.label_3.setText(
            QtWidgets.QApplication.translate("ElementsWindow", "  Filter:  ", None, -1)
        )
        self.label_2.setText(
            QtWidgets.QApplication.translate("ElementsWindow", "Component: ", None, -1)
        )
        self.label_4.setText(
            QtWidgets.QApplication.translate("ElementsWindow", "  Layer:  ", None, -1)
        )
