...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        QtCore.QObject.connect(
            self.addButton, QtCore.SIGNAL("clicked()"), MainWindow.addRow
        )
        QtCore.QObject.connect(
            self.deleteButton, QtCore.SIGNAL("clicked()"), MainWindow.deleteRow
        )
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.deleteButton.setText(
            QtWidgets.QApplication.translate("MainWindow", "Delete variable", None, -1)
        )
        self.addButton.setText(
            QtWidgets.QApplication.translate("MainWindow", "Add variable", None, -1)
        )
