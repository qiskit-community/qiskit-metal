...
If you plan to contribute code, you need extra packages, which you can install by running the following command instead of (or after) the previous one:
```
python -m pip install --no-deps -r requirements-dev.txt -e .
```
