...
class TestElements(unittest.TestCase):
    ...
    def test_qgeometry_is_qgeometry_table(self):
        ...
        self.assertEqual(qgeometries_handler.is_qgeometry_table(QGeometryTables), True)
        self.assertEqual(qgeometries_handler.is_qgeometry_table("i_am_a_string"), False)
    ...
    def test_qgeometry_q_element_create_tables(self):
        ...
        element_handler.py."""
        is_pandas_gt_3 = pandas.__version__ >= "3"
        _str_type = "str" if is_pandas_gt_3 else object
        ...
        self.assertEqual(actual["path"].dtypes["component"], _str_type)
        self.assertEqual(actual["path"].dtypes["name"], _str_type)
        self.assertEqual(actual["path"].dtypes["subtract"], bool)
        self.assertEqual(actual["path"].dtypes["helper"], bool)
        self.assertEqual(actual["path"].dtypes["chip"], _str_type)
        self.assertEqual(actual["path"].dtypes["fillet"], object)

        self.assertEqual(actual["poly"].dtypes["component"], _str_type)
        self.assertEqual(actual["poly"].dtypes["name"], _str_type)
        self.assertEqual(actual["poly"].dtypes["subtract"], bool)
        self.assertEqual(actual["poly"].dtypes["helper"], bool)
        self.assertEqual(actual["poly"].dtypes["chip"], _str_type)
        self.assertEqual(actual["poly"].dtypes["fillet"], object)

        self.assertEqual(actual["junction"].dtypes["component"], _str_type)
        self.assertEqual(actual["junction"].dtypes["name"], _str_type)
        self.assertEqual(actual["junction"].dtypes["subtract"], bool)
        self.assertEqual(actual["junction"].dtypes["helper"], bool)
        self.assertEqual(actual["junction"].dtypes["chip"], _str_type)
