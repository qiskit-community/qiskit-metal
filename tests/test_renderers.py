...
class TestRenderers(unittest.TestCase):
    ...
    def test_renderer_instantiate_gdsrender(self):
        ...
        try:
            ...
            self.fail("QGDSRenderer(design, initiate=False, render_template={}) failed")

        try:
            QGDSRenderer(design, initiate=False, render_options={})
        except Exception:
            self.fail("QGDSRenderer(design, initiate=False, render_options={}) failed")
    ...
    def test_renderer_instantiate_qgmsh_renderer(self):
        ...
        try:
            ...
            self.fail("QGmshRenderer(design, initiate=False) failed in DesignPLanar")
    ...
    def test_renderer_instantiate_qelmer_renderer(self):
        ...
        try:
            ...
            self.fail("QElmerRenderer(design, initiate=False) failed in MultiPlanar")
    ...
    def test_renderer_qansys_renderer_options(self):
        ...
        self.assertEqual(options["plot_ansys_fields_options"]["name"], "NAME:Mag_E1")
        self.assertEqual(options["plot_ansys_fields_options"]["UserSpecifyName"], "0")
        self.assertEqual(options["plot_ansys_fields_options"]["UserSpecifyFolder"], "0")
        self.assertEqual(options["plot_ansys_fields_options"]["QuantityName"], "Mag_E")
        self.assertEqual(options["plot_ansys_fields_options"]["PlotFolder"], "E Field")
        self.assertEqual(
        ...
        self.assertEqual(options["plot_ansys_fields_options"]["FullModelPlot"], "False")
        self.assertEqual(
            options["plot_ansys_fields_options"]["IntrinsicVar"], "Phase='0deg'"
        )
        self.assertEqual(options["plot_ansys_fields_options"]["PlotGeomInfo_0"], "1")
        self.assertEqual(
            options["plot_ansys_fields_options"]["PlotGeomInfo_1"], "Surface"
        )
        self.assertEqual(
            options["plot_ansys_fields_options"]["PlotGeomInfo_2"], "FacesList"
        )
        self.assertEqual(options["plot_ansys_fields_options"]["PlotGeomInfo_3"], "1")
    ...
    def test_renderer_qansysrenderer_default_setup(self):
        ...
        self.assertEqual(default_setup["q3d"]["auto_increase_solution_order"], "True")
    ...
    def test_renderer_qelmer_renderer_default_setup(self):
        ...
        self.assertEqual(default_setup["capacitance"]["Calculate_Electric_Field"], True)
        self.assertEqual(
        ...
        self.assertEqual(
            default_setup["capacitance"]["Linear_System_Solver"], "Iterative"
        )
        self.assertEqual(
            default_setup["capacitance"]["Steady_State_Convergence_Tolerance"], 1e-05
        )
        self.assertEqual(
        ...
        self.assertEqual(
            default_setup["capacitance"]["Linear_System_Convergence_Tolerance"], 1e-10
        )
        self.assertEqual(
            default_setup["capacitance"]["Linear_System_Max_Iterations"], 500
        )
        self.assertEqual(
            default_setup["capacitance"]["Linear_System_Iterative_Method"], "BiCGStab"
        )
        self.assertEqual(default_setup["capacitance"]["BiCGstabl_polynomial_degree"], 2)

        self.assertEqual(default_setup["materials"], ["vacuum", "silicon"])

        self.assertEqual(
            default_setup["constants"]["Permittivity_of_Vacuum"], 8.8542e-12
        )
    ...
    def test_renderer_gdsrenderer_options(self):
        ...
        self.assertEqual(options["check_short_segments_by_scaling_fillet"], "2.0")
    ...
    def test_renderer_qgmsh_renderer_options(self):
        ...
        self.assertEqual(
            options["mesh"]["mesh_size_fields"]["min_distance_from_edges"], "10um"
        )
        self.assertEqual(
            options["mesh"]["mesh_size_fields"]["max_distance_from_edges"], "130um"
        )
        self.assertEqual(options["mesh"]["mesh_size_fields"]["distance_delta"], "30um")
        self.assertEqual(options["mesh"]["mesh_size_fields"]["gradient_delta"], "3um")
