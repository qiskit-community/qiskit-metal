...
class TestComponentOptions(unittest.TestCase, AssertionsMixin):
    ...
    def test_qlibrary_transmon_pocket_6_options(self):
        ...
        self.assertEqual(options["_default_connection_pads"]["pad_width"], "125um")
        self.assertEqual(options["_default_connection_pads"]["pad_height"], "30um")
        self.assertEqual(options["_default_connection_pads"]["pad_cpw_shift"], "0um")
        self.assertEqual(options["_default_connection_pads"]["pad_cpw_extent"], "25um")
        self.assertEqual(options["_default_connection_pads"]["cpw_width"], "10um")
        self.assertEqual(options["_default_connection_pads"]["cpw_gap"], "6um")
        self.assertEqual(options["_default_connection_pads"]["cpw_extend"], "100um")
        self.assertEqual(options["_default_connection_pads"]["pocket_extent"], "5um")
        self.assertEqual(options["_default_connection_pads"]["pocket_rise"], "0um")
    ...
    def test_qlibrary_transmon_pocket_teeth_options(self):
        ...
        self.assertEqual(len(options["_default_connection_pads"]), 12)
        self.assertEqual(options["_default_connection_pads"]["pad_gap"], "15um")
        self.assertEqual(options["_default_connection_pads"]["pad_width"], "20um")
        self.assertEqual(options["_default_connection_pads"]["pad_height"], "150um")
        self.assertEqual(options["_default_connection_pads"]["pad_cpw_shift"], "0um")
        self.assertEqual(options["_default_connection_pads"]["pad_cpw_extent"], "25um")
        self.assertEqual(options["_default_connection_pads"]["cpw_width"], "10um")
        self.assertEqual(options["_default_connection_pads"]["cpw_gap"], "6um")
    ...
    def test_qlibrary_transmon_cross_options(self):
        ...
        self.assertEqual(_options["_default_connection_pads"]["claw_cpw_width"], "10um")
    ...
    def test_qlibrary_jj_manhattan_options(self):
        ...
        design = designs.DesignPlanar()
        my_jj_manhattan = jj_manhattan(design, name="test_jj_manhattan", options={})
        ...
        def test_qlibrary_BridgeFreeJunction_options(self):
            ...
            self.assertEqual(
                options["Evaporation angle of the second evaporation (˚)"], "30"
            )
            ...
            self.assertEqual(
                options["Thickness of the first (bottom) resist layer."], "0.3um"
            )
            self.assertEqual(
