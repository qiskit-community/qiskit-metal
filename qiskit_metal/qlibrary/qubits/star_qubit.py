...
class StarQubit(QComponent):
    ...
    def make(self):
        ...
        # coordinates for trapezoid to be cut out
        ...
        jjunction = draw.rotate(jjunction, p.rotation1, origin=(0, 0))
        ...
        pins1 = draw.rotate(pins, p.rotation1 + 180, origin=(0, 0))
        pins2 = draw.rotate(pins, p.rotation2 + 180, origin=(0, 0))
        pins3 = draw.rotate(pins, p.rotation3 + 180, origin=(0, 0))
        pins4 = draw.rotate(pins, p.rotation4 + 180, origin=(0, 0))
        pins5 = draw.rotate(pins, p.rotation5 + 180, origin=(0, 0))
        objects = [
            total, jjunction, contact1, contact2, contact3, contact4, contact5,
            pins1, pins2, pins3, pins4, pins5, circle_outer
        ]
