...
class ResonatorLumped(QComponent):
    ...
    def make(self):
        ...
        box_in = draw.rectangle(p.box_width - 2.0*p.perimeter_thickness,
                                p.box_height - 2.0*p.perimeter_thickness, 0.0, 0.0)
        ...
        arc_last = draw.rotate(arc, 180, origin=(0.0, p.perimeter_thickness
                                                 + p.initial + 1.5*p.turn_radius))
    ...
    ##########################
        ...
        self.add_pin('pin_s',
                     ...
                     input_as_norm=True)
        # north pin
        qpa_n = (0.0, -0.5*p.box_height + p.perimeter_thickness
                 + p.initial + 30.0*p.turn_radius)
        qpb_n = (0.0, -0.5*p.box_height + p.perimeter_thickness
                 + p.initial + 30.0*p.turn_radius + p.final)
