...
class ResonatorLumped(QComponent):
    ...
    def make(self):
        ...
        box_in = draw.rectangle(p.box_width - 2.0*p.perimeter_thickness, p.box_height - 2.0*p.perimeter_thickness, 0.0, 0.0)
        ...
        # start the resonator 
        initial = draw.LineString([(0.0, p.perimeter_thickness),(0.0, p.perimeter_thickness + p.initial)])
        ...
        centerx2, centery2 = -0.5*p.box_width + p.outer_space + p.turn_radius, p.perimeter_thickness + p.initial + 2.0*p.turn_radius
        ...
        centerx3, centery3 = 0.5*p.box_width - p.outer_space - p.turn_radius, p.perimeter_thickness + p.initial + 4.0*p.turn_radius
        ...
        # bottom half-line 
        line1 = draw.LineString([(-1.0*p.turn_radius -0.0*p.res_width, 
        ...
        line2 = draw.LineString([(-0.5*p.box_width + p.outer_space + p.turn_radius,
        ...
        line_last = draw.translate(line1, 
                                   0.5*p.box_width - 0.0*p.turn_radius - p.outer_space, 
                                   28*p.turn_radius) 

        # draw the line exiting the rectangle 
        final = draw.LineString([(0.0, p.perimeter_thickness + p.initial + 30.0*p.turn_radius),
                                 (0.0, p.perimeter_thickness + p.initial + 30.0*p.turn_radius + p.final)])
        
        arc_last = draw.rotate(arc, 180, origin=(0.0, p.perimeter_thickness + p.initial + 1.5*p.turn_radius ))
        ...
        objects = [perimeter, initial, arc, arc_left_1, arc_left_2, arc_left_3,
                  arc_left_4, arc_left_5, arc_left_6, arc_left_7, arc_right_1, 
                  arc_right_2, arc_right_2, arc_right_3, arc_right_4, arc_right_4, 
                  arc_right_5, arc_right_6, arc_right_7, arc_last, final, 
                  line1, line2, line3, line4, line5, line6, line7, line8, line9, 
                  line10, line11, line12, line13, line14, line_last]
        ...
        [perimeter, initial, arc, arc_left_1, arc_left_2, arc_left_3,
                  ...
                  arc_right_5, arc_right_6, arc_right_7, arc_last, final, 
                  line1, line2, line3, line4, line5, line6, line7, line8, line9, 
                  line10, line11, line12, line13, line14, line_last] = objects
        ...
        self.add_qgeometry('poly', geom_perimeter, layer=1, subtract=False)
        self.add_qgeometry('path', geom_initial, layer=1, subtract=False, width=p.res_width) 
        self.add_qgeometry('path', geom_arc, layer=1, subtract=False, width=p.res_width) 
        self.add_qgeometry('path', geom_arc_left_1, layer=1, subtract=False, width=p.res_width) 
        self.add_qgeometry('path', geom_arc_left_2, layer=1, subtract=False, width=p.res_width)         
        self.add_qgeometry('path', geom_arc_left_3, layer=1, subtract=False, width=p.res_width)         
        self.add_qgeometry('path', geom_arc_left_4, layer=1, subtract=False, width=p.res_width)      
        self.add_qgeometry('path', geom_arc_left_5, layer=1, subtract=False, width=p.res_width)         
        self.add_qgeometry('path', geom_arc_left_6, layer=1, subtract=False, width=p.res_width)         
        self.add_qgeometry('path', geom_arc_left_7, layer=1, subtract=False, width=p.res_width)
        
        self.add_qgeometry('path', geom_arc_right_1, layer=1, subtract=False, width=p.res_width) 
        self.add_qgeometry('path', geom_arc_right_2, layer=1, subtract=False, width=p.res_width)        
        self.add_qgeometry('path', geom_arc_right_3, layer=1, subtract=False, width=p.res_width)
        self.add_qgeometry('path', geom_arc_right_4, layer=1, subtract=False, width=p.res_width) 
        self.add_qgeometry('path', geom_arc_right_5, layer=1, subtract=False, width=p.res_width)        
        self.add_qgeometry('path', geom_arc_right_6, layer=1, subtract=False, width=p.res_width)
        self.add_qgeometry('path', geom_arc_right_7, layer=1, subtract=False, width=p.res_width) 

        self.add_qgeometry('path', geom_arc_last, layer=1, subtract=False, width=p.res_width)         
        
        self.add_qgeometry('path', geom_line1, layer=1, subtract=False, width=p.res_width) 
        self.add_qgeometry('path', geom_line2, layer=1, subtract=False, width=p.res_width)
        self.add_qgeometry('path', geom_line3, layer=1, subtract=False, width=p.res_width)
        self.add_qgeometry('path', geom_line4, layer=1, subtract=False, width=p.res_width)
        self.add_qgeometry('path', geom_line5, layer=1, subtract=False, width=p.res_width)
        self.add_qgeometry('path', geom_line6, layer=1, subtract=False, width=p.res_width)        
        self.add_qgeometry('path', geom_line7, layer=1, subtract=False, width=p.res_width) 
        self.add_qgeometry('path', geom_line8, layer=1, subtract=False, width=p.res_width)   
        self.add_qgeometry('path', geom_line9, layer=1, subtract=False, width=p.res_width)        
        self.add_qgeometry('path', geom_line10, layer=1, subtract=False, width=p.res_width) 
        self.add_qgeometry('path', geom_line11, layer=1, subtract=False, width=p.res_width)  
        self.add_qgeometry('path', geom_line12, layer=1, subtract=False, width=p.res_width)        
        self.add_qgeometry('path', geom_line13, layer=1, subtract=False, width=p.res_width) 
        self.add_qgeometry('path', geom_line14, layer=1, subtract=False, width=p.res_width) 
        self.add_qgeometry('path', geom_line_last, layer=1, subtract=False, width=p.res_width) 
        
        self.add_qgeometry('path', geom_final, layer=1, subtract=False, width=p.res_width) 
    ...
    ##########################
        ...
        # North-East pin
        qpa_ne = (0.5*p.box_width - p.perimeter_thickness, 0.5*p.box_height - p.perimeter_thickness) 
        ...
        # South-East pin
        qpa_se = (0.5*p.box_width - p.perimeter_thickness, -0.5*p.box_height + p.perimeter_thickness) 
        ...
        # North-West pin
        qpa_nw = (-0.5*p.box_width + p.perimeter_thickness, 0.5*p.box_height - p.perimeter_thickness) 
        ...
        # South-West pin
        qpa_sw = (-0.5*p.box_width + p.perimeter_thickness, -0.5*p.box_height + p.perimeter_thickness) 
        ...
        # north pin
        qpa_n = (0.0, -0.5*p.box_height + p.perimeter_thickness + p.initial + 30.0*p.turn_radius) 
        qpb_n = (0.0, -0.5*p.box_height + p.perimeter_thickness + p.initial + 30.0*p.turn_radius + p.final)
