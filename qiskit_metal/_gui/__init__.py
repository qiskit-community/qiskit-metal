...
if config.is_building_docs():
    ...
    from qiskit_metal._gui.widgets.edit_component.component_widget import (
        ComponentWidget,
    )
    from qiskit_metal._gui.widgets.edit_component.table_model_options import (
        QTableModel_Options,
    )
    from qiskit_metal._gui.widgets.edit_component.table_view_options import (
        QTableView_Options,
    )
    from qiskit_metal._gui.widgets.edit_component.tree_model_options import (
        QTreeModel_Options,
    )
    from qiskit_metal._gui.widgets.edit_component.tree_view_options import (
        QTreeView_Options,
    )
    ...
    from qiskit_metal._gui.widgets.variable_table.right_click_table_view import (
        RightClickView,
    )
