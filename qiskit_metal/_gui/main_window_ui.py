...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.toolButton_delete_selected_comp = QtWidgets.QToolButton(self.dockWidgetContents)
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap(":/delete"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.toolButton_delete_selected_comp.setIcon(icon7)
        self.toolButton_delete_selected_comp.setPopupMode(QtWidgets.QToolButton.DelayedPopup)
        self.toolButton_delete_selected_comp.setToolButtonStyle(QtCore.Qt.ToolButtonIconOnly)
        self.toolButton_delete_selected_comp.setObjectName("toolButton_delete_selected_comp")
        self.gridLayout.addWidget(self.toolButton_delete_selected_comp, 0, 2, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.toolButton.setToolTip(_translate("MainWindow", "Focus on component in drawing window"))
        self.toolButton.setStatusTip(_translate("MainWindow", "Focus on component in drawing window"))
        self.toolButton.setText(_translate("MainWindow", "Focus on component in drawing window"))
        self.toolButton_3.setText(_translate("MainWindow", "Actions"))
        self.toolButton_delete_selected_comp.setToolTip(_translate("MainWindow", "Delete a selected component"))
        self.toolButton_delete_selected_comp.setStatusTip(_translate("MainWindow", "Delete a selected component"))
        self.toolButton_delete_selected_comp.setWhatsThis(_translate("MainWindow", "Delete a selected component"))
        self.toolButton_delete_selected_comp.setText(_translate("MainWindow", "Delete"))
        ...
        self.actionComponent.setText(_translate("MainWindow", "Library"))
        self.actionComponent.setToolTip(_translate("MainWindow", "Library of new design components you can create"))
