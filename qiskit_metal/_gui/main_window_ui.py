...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon24 = QtGui.QIcon()
        icon24.addPixmap(QtGui.QPixmap(":/plot/----autozoom"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon25 = QtGui.QIcon()
        icon25.addPixmap(QtGui.QPixmap(":/variables"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.actionBuildHistory.setIcon(icon15)
        ...
        self.toolbar_renderers.addAction(self.actionNew_QComponent)
        ...
        QtCore.QObject.connect(self.actionComponent, QtCore.SIGNAL("triggered()"), self.dockComponent.show)
        ...
        QtCore.QObject.connect(self.dockComponent, QtCore.SIGNAL("visibilityChanged(bool)"), self.actionComponent.setChecked)
        QtCore.QObject.connect(self.dockNewComponent, QtCore.SIGNAL("visibilityChanged(bool)"), self.actionNewComponent.setChecked)
        QtCore.QObject.connect(self.actionNewComponent, QtCore.SIGNAL("triggered(bool)"), self.dockNewComponent.show)
        ...
        QtCore.QObject.connect(self.actionNewComponent, QtCore.SIGNAL("triggered()"), self.dockNewComponent.raise_)
        QtCore.QObject.connect(self.actionComponent, QtCore.SIGNAL("triggered()"), self.dockComponent.raise_)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.dockNewComponent.setToolTip(QtWidgets.QApplication.translate("MainWindow", "Library of components", None, -1))
        self.dockNewComponent.setStatusTip(QtWidgets.QApplication.translate("MainWindow", "Library design components", None, -1))
        self.dockNewComponent.setWhatsThis(QtWidgets.QApplication.translate("MainWindow", "Library design components", None, -1))
        self.dockNewComponent.setWindowTitle(QtWidgets.QApplication.translate("MainWindow", "Library", None, -1))
        self.filter_text_component.setPlaceholderText(QtWidgets.QApplication.translate("MainWindow", "Filter", None, -1))
        ...
        self.actionComponent.setText(QtWidgets.QApplication.translate("MainWindow", "Edit component", None, -1))
        self.actionComponent.setToolTip(QtWidgets.QApplication.translate("MainWindow", "Edit a component of the design (show/hide)", None, -1))
        self.actionComponent.setStatusTip(QtWidgets.QApplication.translate("MainWindow", "Edit a design component", None, -1))
        self.actionComponent.setShortcut(QtWidgets.QApplication.translate("MainWindow", "Ctrl+E", None, -1))
        ...
        self.actionNew_QComponent.setText(QtWidgets.QApplication.translate("MainWindow", "New QComponent", None, -1))
        self.actionNew_QComponent.setToolTip(QtWidgets.QApplication.translate("MainWindow", "Create a new QComponent file", None, -1))
        self.actionNew_QComponent.setShortcut(QtWidgets.QApplication.translate("MainWindow", "Ctrl+N, Meta+N", None, -1))
