...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/metal_logo"),
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(":/main_view"),
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(":/elements"),
                        QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(":/metal_logo"),
                        QtGui.QIcon.Normal, QtGui.QIcon.On)
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(":/help"),
                        QtGui.QIcon.Normal, QtGui.QIcon.On)
        ...
        self.toolBarDesign.setToolButtonStyle(
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(":/fullscreen"),
                        QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap(":/delete"),
                        QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.tableComponents = QTableView_AllComponents(
        ...
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap(":/component"),
                        QtGui.QIcon.Normal, QtGui.QIcon.On)
        ...
        MainWindow.addDockWidget(
            QtCore.Qt.DockWidgetArea(1), self.dockNewComponent)
        ...
        self.log_text.setTextInteractionFlags(QtCore.Qt.LinksAccessibleByKeyboard | QtCore.Qt.LinksAccessibleByMouse |
        ...
        icon10 = QtGui.QIcon()
        icon10.addPixmap(QtGui.QPixmap(":/connectors"),
                         QtGui.QIcon.Normal, QtGui.QIcon.On)
        ...
        MainWindow.addDockWidget(
            QtCore.Qt.DockWidgetArea(1), self.dockConnectors)
        ...
        MainWindow.addDockWidget(
            QtCore.Qt.DockWidgetArea(1), self.dockVariables)
        self.actionSave = QtWidgets.QAction(MainWindow)
        icon11 = QtGui.QIcon()
        icon11.addPixmap(QtGui.QPixmap(":/save"),
                         QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionSave.setIcon(icon11)
        self.actionSave.setObjectName("actionSave")
        self.actionLoad = QtWidgets.QAction(MainWindow)
        icon12 = QtGui.QIcon()
        icon12.addPixmap(QtGui.QPixmap(":/load"),
                         QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon13 = QtGui.QIcon()
        icon13.addPixmap(QtGui.QPixmap(":/design"),
                         QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon14 = QtGui.QIcon()
        icon14.addPixmap(QtGui.QPixmap(":/component"),
                         QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon15 = QtGui.QIcon()
        icon15.addPixmap(QtGui.QPixmap(":/log"),
                         QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon17 = QtGui.QIcon()
        icon17.addPixmap(QtGui.QPixmap(":/delete_all"),
                         QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon20 = QtGui.QIcon()
        icon20.addPixmap(QtGui.QPixmap(":/connectors"),
                         QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon21 = QtGui.QIcon()
        icon21.addPixmap(QtGui.QPixmap(":/screenshot"),
                         QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon22 = QtGui.QIcon()
        icon22.addPixmap(QtGui.QPixmap(":/force_refresh"),
                         QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon23 = QtGui.QIcon()
        icon23.addPixmap(QtGui.QPixmap(":/rebuild"),
                         QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon25 = QtGui.QIcon()
        icon25.addPixmap(QtGui.QPixmap(":/variables"),
                         QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon26 = QtGui.QIcon()
        icon26.addPixmap(QtGui.QPixmap(":/add"),
                         QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.actionElements.toggled['bool'].connect(
            MainWindow._set_element_tab)
        self.actionDelete_All.triggered.connect(
        ...
        self.actionStyleDefault.triggered.connect(
        ...
        self.actionMetal_Dark.triggered.connect(
            MainWindow.load_stylesheet_metal_dark)
        self.dockDesign.visibilityChanged['bool'].connect(
            self.actionDesign.setChecked)
        self.actionDesign.triggered['bool'].connect(self.dockDesign.show)
        self.actionComponent.triggered.connect(self.dockComponent.show)
        self.dockConnectors.visibilityChanged['bool'].connect(
            self.actionConnectors.setChecked)
        self.dockLog.visibilityChanged['bool'].connect(
            self.actionLog.setChecked)
        self.dockComponent.visibilityChanged['bool'].connect(
            self.actionComponent.setChecked)
        self.dockNewComponent.visibilityChanged['bool'].connect(
            self.actionNewComponent.setChecked)
        self.actionNewComponent.triggered['bool'].connect(
            self.dockNewComponent.show)
        self.actionLog.triggered['bool'].connect(self.dockLog.show)
        self.actionConnectors.triggered['bool'].connect(
        ...
        self.actionSave_window_state.triggered.connect(
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate(
            "MainWindow", "Qiskit Metal: Quantum Creator"))
        MainWindow.setToolTip(_translate(
            "MainWindow", "Qiskit Metal: Quantum Creator"))
        MainWindow.setStatusTip(_translate(
            "MainWindow", "Qiskit Metal: Quantum Creator"))
        MainWindow.setWhatsThis(_translate(
            "MainWindow", "Qiskit Metal: Quantum Creator"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(
            self.mainViewTab), _translate("MainWindow", "Main View"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(
            self.tabElements), _translate("MainWindow", "QGeometry"))
        self.tabWidget.setTabToolTip(self.tabWidget.indexOf(self.tabElements), _translate(
        ...
        self.dockDesign.setAccessibleName(
            _translate("MainWindow", "Design Dock"))
        self.dockDesign.setAccessibleDescription(
            _translate("MainWindow", "Design Dock"))
        self.dockDesign.setWindowTitle(_translate("MainWindow", "QComponents"))
        self.btn_comp_zoom.setToolTip(_translate(
            "MainWindow", "Focus on component in drawing window"))
        self.btn_comp_zoom.setStatusTip(_translate(
            "MainWindow", "Focus on component in drawing window"))
        self.btn_comp_zoom.setText(_translate(
            "MainWindow", "Focus on component in drawing window"))
        self.btn_comp_actions.setText(_translate("MainWindow", "Do"))
        self.btn_comp_del.setToolTip(_translate(
            "MainWindow", "Delete a selected component"))
        self.btn_comp_del.setStatusTip(_translate(
            "MainWindow", "Delete a selected component"))
        self.btn_comp_del.setWhatsThis(_translate(
            "MainWindow", "Delete a selected component"))
        ...
        self.dockNewComponent.setToolTip(
            _translate("MainWindow", "Library of components"))
        self.dockNewComponent.setStatusTip(_translate(
            "MainWindow", "Library design components"))
        self.dockNewComponent.setWhatsThis(_translate(
            "MainWindow", "Library design components"))
        ...
        self.dockComponent.setWindowTitle(
            _translate("MainWindow", "Edit component"))
        ...
        self.actionSave.setToolTip(_translate(
            "MainWindow", "Save design to file"))
        self.actionSave.setStatusTip(_translate(
            "MainWindow", "Save design to file"))
        self.actionSave.setWhatsThis(_translate(
            "MainWindow", "Save design to file"))
        self.actionSave.setShortcut(_translate("MainWindow", "Ctrl+S"))
        self.actionLoad.setText(_translate("MainWindow", "Load"))
        self.actionLoad.setToolTip(_translate(
            "MainWindow", "Load design from file"))
        self.actionLoad.setStatusTip(_translate(
            "MainWindow", "Load design from file"))
        self.actionLoad.setWhatsThis(_translate(
            "MainWindow", "Load design from file"))
        self.actionLoad.setShortcut(_translate("MainWindow", "Ctrl+O"))
        self.actionDesign.setText(_translate("MainWindow", "Select component"))
        self.actionDesign.setToolTip(_translate(
            "MainWindow", "Show design window -- select components (show/hide)"))
        self.actionDesign.setShortcut(_translate("MainWindow", "Ctrl+D"))
        self.actionComponent.setText(
            _translate("MainWindow", "Edit component"))
        self.actionComponent.setToolTip(_translate(
            "MainWindow", "Edit a component of the design (show/hide)"))
        self.actionComponent.setStatusTip(_translate(
            "MainWindow", "Edit a design component"))
        self.actionComponent.setShortcut(_translate("MainWindow", "Ctrl+E"))
        self.actionElements.setText(_translate("MainWindow", "QGeometry"))
        self.actionElements.setToolTip(_translate(
            "MainWindow", "Show/hide elements table"))
        self.actionLog.setText(_translate("MainWindow", "Log"))
        self.actionLog.setToolTip(_translate(
            "MainWindow", "Show/hide log window"))
        self.actionLog.setShortcut(_translate("MainWindow", "Ctrl+L"))
        self.actionNewComponent.setText(_translate("MainWindow", "Create"))
        self.actionNewComponent.setToolTip(_translate(
            "MainWindow", "Create new component: Library of new design components you can create"))
        self.actionNewComponent.setStatusTip(_translate(
            "MainWindow", "Create new component: Library of new design components you can create"))
        self.actionNewComponent.setWhatsThis(_translate(
            "MainWindow", "Create new component: Library of new design components you can create"))
        ...
        self.actionDelete_All.setToolTip(_translate(
            "MainWindow", "Delete All Component Objects and QGeometry"))
        self.actionDelete_All.setStatusTip(_translate(
            "MainWindow", "Delete All Component Objects and QGeometry"))
        self.actionDelete_All.setWhatsThis(_translate(
            "MainWindow", "Delete All Component Objects and QGeometry"))
        ...
        self.actionConnectors.setToolTip(_translate(
            "MainWindow", "Show connector pins of qcomponents"))
        ...
        self.actionStyleDefault.setText(
            _translate("MainWindow", "System default"))
        self.actionStyleDark.setText(_translate("MainWindow", "Q Dark"))
        self.actionScreenshot.setText(_translate("MainWindow", "Screenshot"))
        self.actionScreenshot.setToolTip(_translate(
            "MainWindow", "Take a screenshot of the window"))
        self.action_full_refresh.setText(_translate("MainWindow", "Replot"))
        self.action_full_refresh.setToolTip(_translate(
            "MainWindow", "Replot all components (and refresh all gui widgets). Does NOT REBUILD"))
        self.action_full_refresh.setStatusTip(_translate(
            "MainWindow", "Force a full refresh of all plots and widgets"))
        self.action_full_refresh.setWhatsThis(_translate(
            "MainWindow", "Force a full refresh of all plots and widgets"))
        self.action_full_refresh.setShortcut(
            _translate("MainWindow", "Ctrl+R"))
        self.actionRebuild.setText(_translate("MainWindow", "Rebuild"))
        self.actionRebuild.setToolTip(_translate(
            "MainWindow", "Force rebuild all components"))
        self.actionRebuild.setStatusTip(_translate(
            "MainWindow", "Force rebuild all components"))
        self.actionRebuild.setWhatsThis(_translate(
            "MainWindow", "Force rebuild all components"))
        ...
        self.actionFull_Screen.setToolTip(
            _translate("MainWindow", "Go to full screen"))
        self.actionMetal_Dark.setText(_translate("MainWindow", "Metal Dark"))
        self.actionSaveAs.setText(_translate("MainWindow", "Save as"))
        self.actionSaveAs.setToolTip(_translate(
            "MainWindow", "Save design to new file"))
        self.actionSaveAs.setStatusTip(
            _translate("MainWindow", "Save design to file"))
        ...
        self.actionSave_window_state.setText(
            _translate("MainWindow", "Save window state"))
        ...
        self.actionMetal_Window.setText(
            _translate("MainWindow", "Metal Window "))
        self.actionViewDummyLabel.setText(_translate("MainWindow", "View"))
        self.actionVariables.setText(
            _translate("MainWindow", "Design variables"))
        self.actionVariables.setToolTip(_translate(
            "MainWindow", "Edit variables of the QDesign"))
        ...
        self.actionToggleDocks.setToolTip(
            _translate("MainWindow", "ToggleDocks"))
        self.actionToggleDocks.setShortcut(
            _translate("MainWindow", "Meta+F, Ctrl+F"))
        self.actionNew_QComponent.setText(
            _translate("MainWindow", "New QComponent"))
        self.actionNew_QComponent.setToolTip(_translate(
            "MainWindow", "Create a new QComponent file"))
        self.actionNew_QComponent.setShortcut(
            _translate("MainWindow", "Ctrl+N, Meta+N"))
