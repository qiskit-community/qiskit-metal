...
"}")
        ...
        self.verticalLayout_2 = QtWidgets.QVBoxLayout(self.tabElements)
        self.verticalLayout_2.setContentsMargins(0, 0, 0, 0)
        self.verticalLayout_2.setSpacing(0)
        self.verticalLayout_2.setObjectName("verticalLayout_2")
        self.tableElements = QtWidgets.QTableView(self.tabElements)
        self.tableElements.setObjectName("tableElements")
        self.verticalLayout_2.addWidget(self.tableElements)
        ...
        self.component_tab = QtWidgets.QTabWidget(self.widget)
        self.component_tab.setObjectName("component_tab")
        self.verticalLayout_8.addWidget(self.component_tab)
        self.verticalLayout_7.addWidget(self.widget)
        self.dockComponent.setWidget(self.dockWidgetContents_3)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.actionNewComponent.setText(_translate("MainWindow", "New Compt."))
        self.actionNewComponent.setToolTip(_translate("MainWindow", "New Component"))
