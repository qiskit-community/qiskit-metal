...
class Ui_MainWindowPlot(object):
    def setupUi(self, MainWindowPlot):
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(
            QtGui.QPixmap(":/plot/point"), QtGui.QIcon.Normal, QtGui.QIcon.Off
        )
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(
            QtGui.QPixmap(":/plot/refresh_plot"), QtGui.QIcon.Normal, QtGui.QIcon.Off
        )
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(
            QtGui.QPixmap(":/plot/ruler"), QtGui.QIcon.Normal, QtGui.QIcon.Off
        )
        ...
        QtCore.QObject.connect(
            self.actionAuto, QtCore.SIGNAL("triggered()"), MainWindowPlot.auto_scale
        )
        QtCore.QObject.connect(
        ...
        QtCore.QObject.connect(
            self.actionReplot, QtCore.SIGNAL("triggered()"), MainWindowPlot.replot
        )
        QtCore.QMetaObject.connectSlotsByName(MainWindowPlot)

    def retranslateUi(self, MainWindowPlot):
        MainWindowPlot.setWindowTitle(
            QtWidgets.QApplication.translate("MainWindowPlot", "MainWindow", None, -1)
        )
        ...
        self.actionZoom.setToolTip(
            QtWidgets.QApplication.translate("MainWindowPlot", "Zoom control", None, -1)
        )
        self.actionZoom.setShortcut(
            QtWidgets.QApplication.translate("MainWindowPlot", "Z", None, -1)
        )
        self.actionConnectors.setText(
            QtWidgets.QApplication.translate("MainWindowPlot", "Pins", None, -1)
        )
        self.actionConnectors.setToolTip(
            QtWidgets.QApplication.translate(
                "MainWindowPlot",
                "Show connector pins for selected qcomponents",
                None,
                -1,
            )
        )
        ...
        self.actionCoords.setText(
            QtWidgets.QApplication.translate("MainWindowPlot", "Get point", None, -1)
        )
        ...
        self.actionAuto.setText(
            QtWidgets.QApplication.translate("MainWindowPlot", "Autoscale", None, -1)
        )
        self.actionAuto.setToolTip(
            QtWidgets.QApplication.translate("MainWindowPlot", "Auto Zoom", None, -1)
        )
        self.actionAuto.setShortcut(
            QtWidgets.QApplication.translate("MainWindowPlot", "A", None, -1)
        )
        self.actionReplot.setText(
            QtWidgets.QApplication.translate("MainWindowPlot", "Replot", None, -1)
        )
        self.actionReplot.setShortcut(
            QtWidgets.QApplication.translate("MainWindowPlot", "Ctrl+R", None, -1)
        )
        self.actionRuler.setText(
            QtWidgets.QApplication.translate("MainWindowPlot", "Ruler", None, -1)
        )
        self.actionRuler.setToolTip(
            QtWidgets.QApplication.translate(
                "MainWindowPlot", "Activate the ruler", None, -1
            )
        )
