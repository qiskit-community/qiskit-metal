...
class Ui_MainWindowPlot(object):
    def setupUi(self, MainWindowPlot):
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(":/connectors"),
                        QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(":/plot/point"),
                        QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(":/plot/autozoom"),
                        QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.actionCoords.triggered['bool'].connect(
    ...
    def retranslateUi(self, MainWindowPlot):
        ...
        MainWindowPlot.setWindowTitle(
            _translate("MainWindowPlot", "MainWindow"))
        ...
        self.actionZoom.setToolTip(_translate(
            "MainWindowPlot", "Zoom control"))
        ...
        self.actionConnectors.setToolTip(_translate(
            "MainWindowPlot", "Show connectors pins for selected qcomponents"))
        ...
        self.actionCoords.setToolTip(_translate(
            "MainWindowPlot", "Click for position --- Enable this to click on the plot and log the (x,y) position"))
