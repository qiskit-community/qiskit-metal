...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        #self.centralwidget.setGeometry(QtCore.Qrect(300, 300, 646 ,544))
        #layout = QtWidgets.QVBoxLayout()
        #WindowGrip = QtWidgets.QSizeGrip(MainWindow)
        #layout.addWidget(WindowGrip, 0, QtCore.Qt.AlignBottom | QtCore.Qt.AlignRight)
        ...
        #self.instructionsLabel.setGeometry(QtCore.QRect(layout))
        #self.instructionsLabel.setLayout(layout)
        self.instructionsLabel.setObjectName("instructionsLabel")
        self.horizontalLayoutWidget_2 = QtWidgets.QWidget(self.centralwidget)
        self.horizontalLayoutWidget_2.setGeometry(QtCore.QRect(
            10, 470, 301, 32))
        #self.horizontalLayoutWidget_2.setLayout(layout)
        ...
        #self.listView.setGeometry(QtCore.QRect(layout))
        ...
        #self.instructionsLabel_2.setGeometry(QtCore.QRect(layout))
        self.instructionsLabel_2.setAlignment(QtCore.Qt.AlignCenter)
        #self.instructionsLabel_2.setLayout(layout)
        ...
        #self.horizontalLayoutWidget.setLayout(layout)
        ...
        #self.solnComboBox.setLayout(layout)
        ...
        #self.solutionLabel.setLayout(layout)
