...
class Ui_EditSource(object):
    def setupUi(self, EditSource):
        ...
        EditSource.resize(644, 582)
        self.verticalLayout = QtWidgets.QVBoxLayout(EditSource)
        self.verticalLayout.setContentsMargins(0, 6, 0, 0)
        self.verticalLayout.setSpacing(0)
        self.verticalLayout.setObjectName("verticalLayout")
        self.horizontalLayout = QtWidgets.QHBoxLayout()
        self.horizontalLayout.setObjectName("horizontalLayout")
        self.btn_rebuild = QtWidgets.QPushButton(EditSource)
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
...
"color: rgb(255, 255, 255);")
        ...
        self.line = QtWidgets.QFrame(EditSource)
        self.line.setFrameShape(QtWidgets.QFrame.VLine)
        self.line.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.line.setObjectName("line")
        self.horizontalLayout.addWidget(self.line)
        self.btn_save = QtWidgets.QPushButton(EditSource)
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        ...
        self.btn_reload = QtWidgets.QPushButton(EditSource)
        icon2 = QtGui.QIcon()
        ...
        self.src_editor = MetalSourceEditor(EditSource)
        ...
        self.undo = QtWidgets.QPushButton(EditSource)
        icon3 = QtGui.QIcon()
        ...
        self.zoomin = QtWidgets.QPushButton(EditSource)
        icon4 = QtGui.QIcon()
        ...
        self.zoomout = QtWidgets.QPushButton(EditSource)
        self.zoomout.setIcon(icon4)
        self.zoomout.setObjectName("zoomout")
        self.horizontalLayout_3.addWidget(self.zoomout)
        self.center = QtWidgets.QPushButton(EditSource)
        icon5 = QtGui.QIcon()
        ...
        self.full_screen = QtWidgets.QPushButton(EditSource)
        icon6 = QtGui.QIcon()
        ...
        self.lineSrcPath = QtWidgets.QLineEdit(EditSource)
        self.lineSrcPath.setReadOnly(True)
        self.lineSrcPath.setObjectName("lineSrcPath")
        self.horizontalLayout_5.addWidget(self.lineSrcPath)
    ...
    def retranslateUi(self, EditSource):
        ...
        EditSource.setWindowTitle(_translate("EditSource", "Form"))
