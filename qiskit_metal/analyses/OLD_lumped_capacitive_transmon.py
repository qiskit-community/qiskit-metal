...
"""
Created on Thu Mar 15 16:39:07 2018

@author: Jay Gambetta, Zlatko K. Minev, Thomas McConkey

Convert capacitance matrices into Hamiltonian parameters
...
* 2019-04-02 - Zlatko Minev
    Aded import funcitons for Q3D import, and calculation of units.
...
def jayNoscillator(capMatrix, Ic, CJ, N, fb, fr, res_L4_corr=None):
    """
    ...
    Cg = [-capMatrix[qubit_index[0], ground_index], -
