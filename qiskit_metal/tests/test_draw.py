...
class TestDraw(unittest.TestCase, AssertionsMixin):
    ...
    def test_draw_basic_buffer(self):
        ...
        if version_tuple[0] == '3' and int(version_tuple[1]) < 10:
            ...
            expected = [[(-0.16180339887498946, -0.1), (0.25, 0.7236067977499789), 
                        (0.6618033988749894, -0.1), (-0.16180339887498946, -0.1)],
                        [(-0.16180339887498946, -0.1), (0.25, 0.7236067977499789), 
                        (0.6618033988749894, -0.1), (-0.16180339887498946, -0.1)],
                        [(-0.16180339887498946, -0.1), (0.25, 0.7236067977499789), 
                        (0.6618033988749894, -0.1), (-0.16180339887498946, -0.1)],
                        [(-0.08944271909999159, 0.044721359549995794), 
