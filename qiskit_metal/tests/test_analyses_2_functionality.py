    ...
    def test_analyses_lumped_load_q3d_capacitance_matrix(self):
        ...
        for i in range(data_points):
            for j in [
                ...
                self.assertAlmostEqual(
                    test_a_df_cmat_expected[j][i], test_a_df_cmat_result[j][i], places=3
                )
        ...
        for i in range(data_points):
            for j in [
                ...
                self.assertAlmostEqual(
                    test_a_df_cond_expected[j][i], test_a_df_cond_result[j][i], places=3
                )
        ...
        for i in range(data_points):
            for j in [
                ...
                self.assertAlmostEqual(
                    test_b_df_cmat_expected[j][i], test_b_df_cmat_result[j][i], places=3
                )
        ...
        for i in range(data_points):
            for j in [
                ...
                self.assertAlmostEqual(
                    test_b_df_cond_expected[j][i], test_b_df_cond_result[j][i], places=3
                )
