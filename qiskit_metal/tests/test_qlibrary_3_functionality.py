...
class TestComponentFunctionality(unittest.TestCase, AssertionsMixin):
    ...
    def test_qlibrary_get_nested_dict_item(self):
        ...
        my_dict = Dict(
            aa=Dict(x1={"dda": "34fF"}, y1="Y", z="10um"),
        ...
        self.assertEqual({"x1": {"dda": "34fF"}, "y1": "Y", "z": "10um"}, _test_c)
    ...
    def test_qlibrary_qcomponent_add_pins(self):
        ...
        my_q_component.add_pin("pin1-name", np.array(spiral_list_0.coords)[-2:], 0.1)
        my_q_component.add_pin("pin2-name", np.array(spiral_list_1.coords)[-2:], 0.1)
        ...
        self.assertEqual(my_pins["pin1-name"]["points"][0][0], -35.0)
        self.assertEqual(my_pins["pin1-name"]["points"][0][1], 30.0)
        self.assertEqual(my_pins["pin1-name"]["points"][1][0], -35.0)
        self.assertEqual(my_pins["pin1-name"]["points"][1][1], -35.0)
        self.assertEqual(len(my_pins["pin1-name"]["middle"]), 2)
        self.assertEqual(my_pins["pin1-name"]["middle"][0], -35.0)
        self.assertEqual(my_pins["pin1-name"]["middle"][1], -2.5)
        self.assertEqual(len(my_pins["pin1-name"]["normal"]), 2)
        self.assertEqual(my_pins["pin1-name"]["normal"][0], 1.0)
        self.assertEqual(my_pins["pin1-name"]["normal"][1], -0.0)
        self.assertEqual(len(my_pins["pin1-name"]["tangent"]), 2)
        self.assertEqual(my_pins["pin1-name"]["tangent"][0], 0.0)
        self.assertEqual(my_pins["pin1-name"]["tangent"][1], -1.0)
        ...
        self.assertEqual(my_pins["pin2-name"]["points"][0][0], -34.0)
        self.assertEqual(my_pins["pin2-name"]["points"][0][1], 32.0)
        self.assertEqual(my_pins["pin2-name"]["points"][1][0], -34.0)
        self.assertEqual(my_pins["pin2-name"]["points"][1][1], -33.0)
        self.assertEqual(len(my_pins["pin2-name"]["middle"]), 2)
        self.assertEqual(my_pins["pin2-name"]["middle"][0], -34.0)
        self.assertEqual(my_pins["pin2-name"]["middle"][1], -0.5)
        self.assertEqual(len(my_pins["pin2-name"]["normal"]), 2)
        self.assertEqual(my_pins["pin2-name"]["normal"][0], 1.0)
        self.assertEqual(my_pins["pin2-name"]["normal"][1], -0.0)
        self.assertEqual(len(my_pins["pin2-name"]["tangent"]), 2)
        self.assertEqual(my_pins["pin2-name"]["tangent"][0], 0.0)
        self.assertEqual(my_pins["pin2-name"]["tangent"][1], -1.0)
    ...
    def test_qlibrary_template_component_metadata(self):
        ...
        self.assertEqual(component.component_metadata, {"short_name": "component"})
    ...
    def test_qlibrary_qcomponent_add_and_get_pin(self):
        ...
        self.assertEqual(my_pin["points"][0][0], -34.0)
        self.assertEqual(my_pin["points"][0][1], 32.0)
        self.assertEqual(my_pin["points"][1][0], -34.0)
        self.assertEqual(my_pin["points"][1][1], -33.0)
        self.assertEqual(len(my_pin["middle"]), 2)
        self.assertEqual(my_pin["middle"][0], -34.0)
        self.assertEqual(my_pin["middle"][1], -0.5)
        self.assertEqual(len(my_pin["normal"]), 2)
        self.assertEqual(my_pin["normal"][0], 1.0)
        self.assertEqual(my_pin["normal"][1], -0.0)
        self.assertEqual(len(my_pin["tangent"]), 2)
        self.assertEqual(my_pin["tangent"][0], 0.0)
        self.assertEqual(my_pin["tangent"][1], -1.0)
    ...
    def test_qlibrary_delete_component(self):
        ...
        before_junction_list = design.qgeometry.tables["junction"]["component"].tolist()
        ...
        after_junction_list = design.qgeometry.tables["junction"]["component"].tolist()
    ...
    def test_qlibrary_anchored_path_intersecting(self):
        ...
        self.assertTrue(
            anchored_path.intersecting(
                np.array([1, 1]), np.array([3, 3]), np.array([1, 3]), np.array([3, 1])
            )
        )
        self.assertFalse(
            anchored_path.intersecting(
                np.array([1, 1]), np.array([3, 3]), np.array([5, 5]), np.array([7, 7])
            )
        )
